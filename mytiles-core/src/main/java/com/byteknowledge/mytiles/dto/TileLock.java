...
public class TileLock implements Serializable {
    ...
    public String toString() {
        return "TileLock [tileId=" + tileId + ", tileUserId=" + tileUserId + ", tileTimestamp=" + tileTimestamp
