...
public class TileBoardRestControllerTest extends AbstractRestControllerTest {
	...
	@Autowired
	protected TileBoardDao tileBoardDao;
	
	protected TileBoard tileBoardRadical;
	protected TileBoard tileBoardTubular;
	...
	protected void setUpData() {
        ...
        tileBoardRadical = new TileBoard();
        tileBoardRadical.setId(UUID.fromString(Service.TILEBOARD_ID));
        tileBoardRadical.setCreatorId(UUID.fromString(Service.USER1_ID));
        tileBoardRadical.setOwnerId(UUID.fromString(Service.USER1_ID));
        tileBoardRadical.setCreatedTime(Calendar.getInstance().getTimeInMillis());
        tileBoardRadical.setTileBagId(tileBagCool.getId());
        tileBoardRadical.setName("Board of Radicalness");
        tileBoardRadical.addParticipant(userFrank).addParticipant(userAndrew);
        tileBoardDao.save(tileBoardRadical);
        
        tileBoardTubular = new TileBoard();
        tileBoardTubular.setCreatorId(UUID.fromString(Service.USER2_ID));
        tileBoardTubular.setOwnerId(UUID.fromString(Service.USER2_ID));
        tileBoardTubular.setCreatedTime(Calendar.getInstance().getTimeInMillis());
        tileBoardTubular.setTileBagId(tileBagAwesome.getId());
        tileBoardTubular.setName("Board of Tubularness");
        tileBoardTubular.addParticipant(userFrank).addParticipant(userAndrew);
        tileBoardDao.save(tileBoardTubular);
	}
