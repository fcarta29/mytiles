<script type="text/javascript">
    ...
    function connect() {
        var socket = new SockJS('http://ws.mytiles.me/mytiles/');
    ...
    function setConnected(connected) {
        ...
        if (connected) {
            ...
            $.get("http://api.mytiles.me/tileplacements/tileboard/07270496-d622-4351-a4df-d4f28b31fe5c/tilebag/7194d3ea-b2be-4e1f-b606-8d5867bb5a34", function(placements) {
